...
export const initPagination = ({pages, fromRow, toRow, totalRows}, createPage) => {
    ...
    // Выведите кнопки пагинации и убедитесь, что они работают.
    ...
    return (data, state, action) => {
        ...
        // Посчитайте число страниц и выведите только нужные строки. 
        const rowsPerPage = state.rowsPerPage; // Сколько строк показывать на странице
        ...
        // Обработайте действия в пагинации «предыдущая», «следующая», «первая», «последняя» страницы. 
        // Для этого после комментария // @todo: #2.6 проверим, что перерисовка была вызвана действием. 
        // Это значит, что именно action будет элементом кнопки, а не undefined. 
        // И если это так, то следует обработать действия только тех кнопок, которые относятся к нашему модулю
        ...
        // верните из модуля только те строки, которые нужно отобразить для текущей страницы.
