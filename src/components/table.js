...
export function initTable(settings, onAction) {
  ...
  before.reverse().forEach((subName) => {
    // reverse - разворачивает порядок элементов в массиве
